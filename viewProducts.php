                ...
                if (!empty($products)) {
                    foreach ($products as $product): ?>
                        <article class="product-view">
                            <h2 class="small-heading"><?php echo htmlspecialchars($product['productTitle']) ?></h2>
                            <div class="product-inner-container">
                                ...
                                <div class="product-inner-container">
                                    <p><span class="logo-colour-2">Title:
                                        </span><?php echo htmlspecialchars($product['productTitle']) ?></p>
                                    <p><span class="logo-colour-2">Manufacturer:
                                        </span><?php echo htmlspecialchars($product['productManufacturer']) ?></p>
                                    <p class="view-products-description"><span class="logo-colour-2">Description:
                                        </span><?php echo htmlspecialchars($product['productDescription']) ?></p>
                                    ...
                                    <p><span class="logo-colour-2">Weight:
                                        </span><?php echo htmlspecialchars($product["productWeight"]) ?>lbs</p>
                                    <p><span class="logo-colour-2">Price:
                                        </span>$<?php echo number_format($product['productPrice'], 2) ?></p>
                                    <p><span class="logo-colour-2">Condition:
                                        </span><?php echo htmlspecialchars($product['productCondition']) ?></p>
                                </div>

                            </div>
                            <div class="product-inner-container-row">
                                <a class="no-dec logo-colour hover-colour-2 bold"
                                    href="editProduct.php?id=<?php echo $product['ID'] ?>">Edit</a>
                                <a class="no-dec logo-colour hover-colour-2 bold"
                                    href="viewProducts.php?delete=<?php echo $product['ID'] ?>"
