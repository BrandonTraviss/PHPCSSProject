...
2. Run the included SQL files to create the required tables. (Ensure the database you created is selected)
3. Setup your inc/config.php file with your DB_NAME, DB_USERNAME, DB_PASS, DB_HOST_NAME
