    ...
    <main class="contact-main">
        <form class="contact-form" action="POST">
            ...
            <p class="contact-intro">
                Whether you're a retro gaming enthusiast, a collector, or just curious about our handcrafted cabinets,
                we'd love to hear from you. Fill out the form below and we'll get back to you within 1–2 business days.
            </p>
